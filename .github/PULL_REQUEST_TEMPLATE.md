...
Powerset supports Claude Code and Codex only. PRs adding support for other IDEs,
CLIs, agent runners, or plugin systems are out of scope for this fork.

- [ ] This PR only affects Claude Code and/or Codex support
